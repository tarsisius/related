		...
		o = function(e) {
			...
			if (c) {
				for (var v = 0; v < l.relatedPosts && v != o.length; v++) {
					...
					1 == p ? m += '<li><a class="ngentot" href="' + a + '" ' + u + ">" + s + "</a></li>" : 2 == p ? m += '<li><a class="ngentot" href="' + a + '" ' + u + '><div class="related-title">' + s + '</div></a><div class="related-snippets">' + n + "</div></li>" : 3 == p ? m += '<li class="related-post-item" style="' + h + '"><a class="ngentot" href="' + a + '" ' + u + '><img alt="" class="related-thumb-large" src="' + i + '" style="' + g + '"><div class="related-title">' + s + '</div></a><div class="related-snippets">' + n + "</div></li>" : 4 == p ? m += '<li class="related-post-item" style="' + h + '"><a class="ngentot" href="' + a + '" ' + u + '><img alt="" class="related-thumb-large" src="' + i + '" style="' + g + '"><div class="related-title">' + s + '</div></a><div class="related-date">' + postdate + "</div></li>" : 5 == p ? m += '<li class="related-post-item" style="' + h + '"><a class="ngentot" href="' + a + '" ' + u + '><img alt="" class="related-thumb-large" src="' + i + '" style="' + g + '"><div class="related-title">' + s + "</div></a></li>" : 6 == p ? m += '<li class="related-post-item"><a class="ngentot" href="' + a + '" ' + u + '><img alt="" class="related-thumb-large" src="' + i + '" style="' + g + '"><div class="related-wrapper" style="' + g + '"><div class="related-wrapper-inner"><div class="related-title">' + s + "</div></div></div></a></li>" : 7 == p ? m += '<li class="related-post-item"><a class="ngentot" href="' + a + '" ' + u + '><img alt="" class="related-thumb-large" src="' + i + '" style="' + g + '"></a></li>' : 8 == p ? m += '<li class="related-post-item"><a class="ngentot" class="related-post-item-wrapper" href="' + a + '" ' + u + '><img alt="" class="related-thumb" src="' + i + '" style="' + g + '"><div class="related-title">' + s + '</div></a><div class="related-date">' + postdate + "</div></li>" : 9 == p && (m += '<li><a class="ngentot" href="' + a + '" ' + u + '><img alt="" class="related-thumb" src="' + i + '" style="' + g + '"><div class="related-title">' + s + '</div></a><div class="related-snippets">' + n + "</div></li>")
				}
